...
import { BrainCog, Calendar, LetterText } from "lucide-react"

const aboutSections = [
    {
        id:1,
        title: "Développeur Frontend.",
        description: "Je suis un développeur Frondend Réact.",
...

    {
        ...
        description: "Je suis un développeur Backend Django.",
        icon: <Calendar className="text-accent scale-150"/>
    },
            ...
            <div className="md:h-screen flex justify-center items-center">
                ...
                <div className="md:ml-4 space-y-4">
                    ...
                    {aboutSections.map((section) => (
                        ...
                        <div key={section.id} 
                            className="flex flex-col flex-row items-center bg-base-100 p-5 rounded-xl md:w-96 shadow-xl">
